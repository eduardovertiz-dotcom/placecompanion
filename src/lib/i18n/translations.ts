...
export const translations = {
  en: {
    ...
    hero: {
      ...
      subhead: 'Your front desk fields 200+ guest questions a day. Now it doesn\'t have to.',
    ...
    onboarding: {
      ...
      roomCountOptions: ['1–10', '11–25', '26–50', '51–100', '100+'],
    ...
    dashboard: {
      ...
      invoiceDesc: 'To request an invoice for your subscription, email us at billing@placecompanion.com with your account email and we\'ll send it within 24 hours.',
      invoiceClose: 'Close',
  ...
  es: {
    ...
    hero: {
      ...
      subhead: 'Tu recepción atiende 200+ preguntas de huéspedes al día. Ahora no tiene que hacerlo.',
    ...
    dashboard: {
      ...
      invoiceDesc: 'Para solicitar una factura de tu suscripción, envía un email a billing@placecompanion.com con tu email de cuenta y te la enviamos en 24 horas.',
      invoiceClose: 'Cerrar',
