  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'What happens when a guest reports an issue?', a: "Yes — and it works automatically. When a guest mentions any issue, your assistant asks for their room number and sends two email alerts to your team: one immediately when the issue is reported, and a second when the room number is confirmed. Your guest gets a warm, reassuring response. Nothing falls through the cracks." },
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: '¿Qué pasa cuando un huésped reporta una incidencia?', a: 'Sí, y funciona de forma automática. Cuando un huésped menciona cualquier problema, tu asistente solicita el número de habitación y envía dos alertas por email a tu equipo: una de inmediato al reportar el problema, y una segunda al confirmar la habitación. Tu huésped recibe una respuesta cálida y tranquilizadora. Nada se pierde.' },
