  ...
  return (
    <div style={{ background: "#141413" }}>
      ...
      >
        <div>
          <h1
            className="font-serif font-light text-[#FAF9F5] max-w-4xl mx-auto"
            style={{ fontSize: "96px", lineHeight: 1.0 }}
          >
            Hotels are the most human business in the world.
          </h1>
          <p
            className="font-sans text-[#9C9A93] mt-16"
            style={{ fontSize: "22px" }}
          >
      ...
      <section className="py-32" style={{ background: "#141413" }}>
        <div className="max-w-2xl mx-auto px-8">
          ...
          <div className="space-y-6 mt-8">
            <p
              className="font-sans text-[#9C9A93]"
              style={{ fontSize: "18px", lineHeight: 1.8 }}
            >
              A hotel is not a product. It&apos;s a promise — that someone will be
              cared for, that the experience will feel seamless, that every question
              will have a thoughtful answer. But the tools hotels use were built for
              operations, not conversation. PMS systems manage rooms. Booking engines
              capture reservations. Nothing was ever designed to simply talk to guests.
            </p>
            <p
              className="font-sans text-[#9C9A93]"
              style={{ fontSize: "18px", lineHeight: 1.8 }}
            >
              That gap — between the guest&apos;s question and the answer they need —
              costs hotels more than they realize. In revenue missed. In trust eroded.
              In staff energy spent on questions that deserved a better system.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <p
            className="font-serif italic text-[#9C9A93] mt-4"
            style={{ fontSize: "28px" }}
          >
            Which means it knows nothing about your hotel.
          </p>
          <p
            className="font-sans text-[#9C9A93] max-w-xl mx-auto mt-8"
            style={{ fontSize: "18px", lineHeight: 1.75 }}
          >
            Ask any general-purpose AI about your spa hours. It will guess,
            hallucinate, or tell the guest to check your website. The guest was
            already on your website. They needed a conversation, not a redirect.
          </p>
        </div>
      </section>
      ...
      <section className="py-32" style={{ background: "#141413" }}>
        <div className="max-w-2xl mx-auto px-8 text-center">
          ...
          >
            ...
            <path
              d="M28 32c0 0-16 12-16 20h32c0-8-16-20-16-20z"
              stroke="#FAF9F5"
              strokeWidth="1.5"
              strokeLinejoin="round"
            />
          ...
          <p
            className="font-sans text-[#9C9A93] mt-8"
            style={{ fontSize: "18px", lineHeight: 1.75 }}
          >
            They ask where to watch the sunset. Which beach has no seaweed this
            week. Where the locals actually eat. Whether the pharmacy is open on
            Sunday. These questions don&apos;t live in any PMS. They live in local
            knowledge — and until now, that knowledge lived only in your best staff
            member&apos;s head.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-8 mt-12 max-w-2xl mx-auto text-left">
            {[
              ...
              <p
                key={s}
                className="font-serif font-light text-[#FAF9F5]"
          ...
          <p
            className="font-sans text-[#9C9A93] mt-12 text-center"
            style={{ fontSize: "18px" }}
          >
      ...
      <section className="py-32" style={{ background: "#141413" }}>
        <div className="max-w-2xl mx-auto px-8 text-center">
          ...
          <p
            ...
            style={{ fontSize: "18px", lineHeight: 1.8 }}
          >
            Every independent hotel deserves a guest experience that feels personal
            and complete — not because of their budget, but because of their
            knowledge. Place Companion exists to give every boutique property, every
            family-run hotel, every carefully curated collection of rooms — the same
            intelligence that the largest hospitality brands in the world are only
            beginning to build.
          </p>
        </div>
      </section>
